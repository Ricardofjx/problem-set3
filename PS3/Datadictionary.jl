...
function DataDictionary(time_start,time_stop,time_step)
	...
	species_bounds_array = [
		0.0	0.0	;	# 1    M_ATP_c
		0.0	0.0	;	# 2    M_L-Citrulline_c
		0.0	0.0	;	# 3    M_L-Aspartate_c
		0.0	0.0	;	# 4    M_AMP_c
		0.0	0.0	;	# 5    M_Diphosphate_c
		0.0	0.0	;	# 6    M_N-(L-Arginino)succinate_c
		0.0	0.0	;	# 7    M_Fumarate_c
		0.0	0.0	;	# 8    M_L-Arginine_c
		0.0	0.0	;	# 9    M_H2O_c
		0.0	0.0	;	# 10   M_L-Ornithine_c
		0.0	0.0	;	# 11   M_Urea_c
		0.0	0.0	;	# 12   M_Carbamoyl_phosphate_c
		0.0	0.0	;	# 13   M_Orthophosphate_c
		0.0	0.0	;	# 14   M_NADPH_c
		0.0	0.0	;	# 15   M_H_c
		0.0	0.0	;	# 16   M_Oxygen_c
		0.0	0.0	;	# 17   M_Nitric_oxide_c
		0.0	0.0	;	# 18   M_NADP_c
	];
